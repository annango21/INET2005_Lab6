...
class MySQLiActorDataModel implements iActorDataModel
{
    ...
    public function insertActor($actorID,$first_name,$last_name){
        $insertStatement = "INSERT INTO actor (actor_id, first_name, last_name) VALUE('$actorID','$first_name','$last_name')";
    ...
    public function updateActor($actorID, $first_name, $last_name)
    {
        ...
        if (!$this->result) {
            die('Could not insert records in the Sakila Database: ' .
                $this->dbConnection->error);
        }
    ...
    public function deleteActor($actorID)
    {
        ...
        if (!$this->result) {
            die('Could not delete records in the Sakila Database: ' .
                $this->dbConnection->error);
        }
    }
    ...
    public function fetchActorFirstName($row)
    {
        ...
        //column with the current row of
        //
        //  data you are focused on
